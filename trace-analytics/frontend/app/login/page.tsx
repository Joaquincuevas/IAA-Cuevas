      ...
      <div className="flex-1 flex items-center justify-center">
        <div className="w-full max-w-md px-6">
          <div className="text-center mb-8">
            <h1 className="text-[26px] font-bold text-[#111827] tracking-tight">Trace Analytics</h1>
            <p className="text-[14px] text-[#9CA3AF] mt-1.5">powered by Taula</p>
          </div>
          ...
          <p className="text-center text-[12.5px] text-[#9CA3AF] mt-10">
