...
export default function TaulaPage() {
  ...
  return (
    <div className="flex flex-col h-screen">
      {/* Header */}
      <div className="flex items-center justify-between px-7 py-4 border-b border-[#E5E7EB]">
        <div>
          <div className="flex items-center gap-2">
            <h1 className="text-[20px] font-bold text-[#111827] tracking-tight">Taula</h1>
      ...
      {/* Input */}
      <div className="px-7 pb-5 pt-3 border-t border-[#E5E7EB]">
        <div className="flex items-center gap-2 border border-[#E5E7EB] rounded-xl px-4 py-2.5 focus-within:border-[#1B2A4A] transition-colors">
          <input
            ...
            onKeyDown={handleKey}
            disabled={loading}
            className="flex-1 text-[14px] outline-none bg-transparent placeholder-[#9CA3AF]"
          />
          <button
            onClick={() => sendMessage()}
